...
class HelpCog(Cog, name="Help"):
    ...
    async def helpcommand(self, ctx: Context):
        ...
        embed.add_field(name="Mitwirkende", value="Du willst wissen wer bei diesem Bot Mist gebaut hat? So kriegst du die Namen für die Beschwerde raus: \n> contributer", inline=True)
